...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	// Load the vertex array with data. // Firts Triangle
	...
	// Load the index array with data. // Indices Firts Triangle
	indices[0] = 0;  // Bottom left.
	indices[1] = 1;  // Top middle.
	indices[2] = 2;  // Bottom right.


	// Load the index array with data. // Indices second Triangle
